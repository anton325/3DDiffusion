...
from gecco_torch.diffusionsplat import EDMPrecond, Diffusion, LogUniformSchedule, EDMLoss, IdleConditioner
from gecco_torch.reparam import GaussianReparam, get_reparam_parameters
from gecco_torch.models.set_transformer import SetTransformer
from gecco_torch.models.gaussian_lift import LinearLift
...
mode = [Mode.in_world_space, Mode.procrustes, Mode.rgb, Mode.gecco_projection, Mode.log_grads, Mode.splatting_loss, Mode.ctx_splat] # , Mode.ctx_splat, Mode.splatting_loss
...
# mode = [Mode.in_world_space, Mode.rgb, Mode.activated_scales, Mode.rotational_distance, Mode.gecco_projection, Mode.log_grads, Mode.splatting_loss , Mode.ctx_splat]#, Mode.splatting_loss
# mode = [Mode.in_world_space, Mode.rgb, Mode.so3_x0, Mode.rotational_distance, Mode.gecco_projection, Mode.log_grads, Mode.splatting_loss] # , Mode.ctx_splat, Mode.splatting_loss
...
data = datamodule(
    ...
    mode = mode,
    restrict_to_categories=['02691156'] # 02958343 car # 02691156 plane # 03001627 chair 
)
...
network = LinearLift(
    ...
    feature_dim=feature_dims,  # NICHT SICHER OB RICHTIG GEWÄHLT, einfach von taskonomy übernommen
    geometry_dim=len(mean),
    mode = mode,
)
...
if __name__ == "__main__":
    ...
    if on_cluster:
        shutil.copy("/home/wc101072/code/gecco/gecco-torch/example_configs/gaussians_unconditional.py",config_dest)
        ...
        shutil.copy("/home/giese/Documents/gecco/gecco-torch/example_configs/gaussians_unconditional.py",config_dest)
